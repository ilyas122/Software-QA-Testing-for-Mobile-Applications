...
public class BiteSnap {
	AndroidDriver<AndroidElement> driver;
	@Before
	public void setUp() throws MalformedURLException {
		
		System.out.println("Running Automated Test cases on BITESNAP AI Mobile Application");
		...
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.ScrollView/android.widget.ListView/android.widget.LinearLayout/android.widget.LinearLayout[1]").click();
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
	...
	public void TestCase1() {
        ...
        assertEquals("Italian-Cuisine,Nonveg,Snacks", "Lasagna", actualResult);
        if(actualResult.contains("Lasagna")) {
	...
	public void TestCase2() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView").getText();        
        assertEquals("Italian-Cuisine,veg,Dinner", "Spaghetti", actualResult);
        if(actualResult.contains("Spaghetti")) {
	...
	public void TestCase3() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView").getText();        
        assertEquals("Italian-Cuisine,Nonveg,Lunch", "Gnocchi", actualResult);
        if(actualResult.contains("Gnocchi")) {
	...
	public void TestCase4() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView").getText();        
        assertEquals("Italian-Cuisine,Nonveg,Breakfast", "Steak", actualResult);
        if(actualResult.contains("Steak")) {
	...
	public void TestCase5() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView").getText();        
        assertEquals("Italian-Cuisine,Veg,Lunch", "Truffles", actualResult);
        if(actualResult.contains("Truffles")) {
	...
	public void TestCas77() {
		System.out.println("Running TestCase77");
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView").getText();        
        assertEquals("Italian-Cuisine,Veg,Lunch", "Truffles", actualResult);
        if(actualResult.contains("Truffles")) {
	...
	public void TestCase128() {
        ...
        if(actualResult.contains("Truffles")) {
        	...
        	System.out.println("128.Test failed");
        }
        driver.closeApp();
	}
	...
	public void TestCase135() {
        ...
        if(actualResult.contains("Truffles")) {
        	...
        	System.out.println("6135.Test failed");
        }
        driver.closeApp();
	}
	...
	public void TestCase145() {
		...
		public void TestCase156() {
			...
			if(actualResult.contains("Truffles")) {
				...
				System.out.println("156.Test failed");
			}
			driver.closeApp();
		}
		...
		public void TestCase174() {
			System.out.println("Running TestCase-174");
			driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
			String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView").getText();        
			assertEquals("Italian-Cuisine,Veg,Lunch", "Truffles", actualResult);
			if(actualResult.contains("Truffles")) {
		...
		public void TestCase192() {
			System.out.println("Running TestCase-192");
			driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
			String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.widget.TextView").getText();        
			assertEquals("Italian-Cuisine,Veg,Lunch", "Truffles", actualResult);
			if(actualResult.contains("Truffles")) {
