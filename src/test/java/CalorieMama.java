...
public class CalorieMama {
	AndroidDriver<AndroidElement> driver;
	@Before
	public void setUp() throws MalformedURLException {
		
		System.out.println("Running Automated Test cases on CALORIEMAMA AI Mobile Application");
	...
	public void TestCase2() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.Button").getText();        
        assertEquals("Chinese-Cuisine,Nonveg,Dinner", "FRIED RICE", actualResult);
        if(actualResult.contains("FRIED RICE")) {
	...
	public void TestCase3() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.Button").getText();        
        assertEquals("Chinese-Cuisine,Nonveg,Lunch", "CHOW MEIN", actualResult);
        if(actualResult.contains("CHOW MEIN")) {
	...
	public void TestCase4() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.Button").getText();        
        assertEquals("Chinese-Cuisine,veg,Breakfast", "DUMPLING", actualResult);
        if(actualResult.contains("DUMPLING")) {
	...
	public void TestCase5() {
		...
		driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
        String actualResult = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup[2]/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.Button").getText();        
        assertEquals("Chinese-Cuisine,Nonveg,Snacks", "SPRINGROLLS", actualResult);
        if(actualResult.contains("SPRINGROLLS")) {
